...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    animateWithGsap("#featcures-title", { y: 0, opacity: 1 });
    animateWithGsap(
      ".g_grow",
  ...
  return (
    <section className="w-full common-padding overflow-hidden relative bg-zinc">
      <div className="screen-max-width">
        <div className="mb-12 w-full">
          <h1 id="featcures-title" className="section-heading">
